package org.example.kmp_scrcpy_gui.utils
...
class MinimizeFixUtils {
    ...
    private interface User32Ex : User32 {
        ...
        fun CallWindowProc(proc: LONG_PTR, hWnd: HWND, uMsg: Int, uParam: WinDef.WPARAM, lParam: WinDef.LPARAM): WinDef.LRESULT
    }
